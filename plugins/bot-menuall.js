...
await conn.reply(m.chat, '*Enviando El Menu📍...*', fkontak, { contextInfo:{ forwardingScore: 2022, isForwarded: true, externalAdReply: {title: '🥀 ¡Hola!', body: saludo, sourceUrl: global.md, thumbnailUrl: ppBot }}})
m.react('🦊') 
...
handler.tags = ['info']
handler.command = ['help', 'config', 'configuracion'] 
