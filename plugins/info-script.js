...
let res = await fetch('https://api.github.com/repos/ArizzVal/CuriosityBot-MD')
...
await conn.sendUrl(m.chat, git, m, { externalAdReply: { mediaType: 1, renderLargerThumbnail: true, thumbnail: imagen2, thumbnailUrl: imagen1, title: '\t\t\t\t\t\t᭡͡ᩬ🍧✩̣̣̣̣̣ͯZorroBot-MD᭡͡ᩬ🍧✩̣̣̣̣̣ͯ', }})
